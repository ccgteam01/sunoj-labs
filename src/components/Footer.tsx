  ...
  <footer className="bg-primary text-primary-foreground">
    <div className="container py-16">
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-primary-foreground/60">Quick Links</h4>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-primary-foreground/70">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>Room 418-A, 3rd Floor, Dept. of Chemistry, IIT Bombay, Powai, Mumbai 400076</span>
            </div>
          </div>
        </div>
      </div>
      <div className="border-t border-primary-foreground/10 mt-12 pt-8 text-center text-xs text-primary-foreground/40">
        © {new Date().getFullYear()} CCML Group, IIT Bombay. All rights reserved.
      </div>
    </div>
  </footer>
);
