...
import { AwardsSkeleton } from "@/components/Skeleton";
import sunojImage from "@/assets/sunoj-sir.jpg";
import { useAwards } from "@/hooks/use-sanity";

const ProfRBS = () => {
  const { data: awards, isFetching } = useAwards([]);
  return (
    <PageLayout>
      <PageHero 
              ...
              >
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <a
                        href="https://maps.app.goo.gl/8no5u8KKCTRK7qwu5"
                        target="_blank"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <br />
                      <a
                        href="mailto:rbsunoj@iitb.ac.in"
                        className="text-foreground hover:text-accent transition-colors"
                      >
                        rbsunoj@iitb.ac.in
                      </a>
